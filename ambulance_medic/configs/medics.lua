Medics = {
    {
        ...
        Price = 249, -- This is the price the character will be deducted from the bank balance.
    ...
    --    Hash = 0xB353629E,
    --
    --    Price = 199 -- This is the price the character will be deducted from the bank balance.
    --},
}